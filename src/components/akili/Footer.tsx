      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-xs text-muted-foreground">
              <li><a href="https://github.com/gadda00/Akili" target="_blank" rel="noreferrer" className="hover:text-foreground">GitHub</a></li>
              <li>API Docs</li>
              <li>Agent Catalog</li>
              <li>Changelog</li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a href="https://github.com/gadda00/Akili" target="_blank" rel="noreferrer" className="h-8 w-8 rounded-lg bg-muted hover:bg-accent flex items-center justify-center transition-colors">
                <Github className="h-4 w-4" />
              </a>
              <a href="#" className="h-8 w-8 rounded-lg bg-muted hover:bg-accent flex items-center justify-center transition-colors">
                <Twitter className="h-4 w-4" />
              </a>
              <a href="mailto:hello@akili.ai" className="h-8 w-8 rounded-lg bg-muted hover:bg-accent flex items-center justify-center transition-colors">
        ...
        <div className="pt-6 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-muted-foreground">
          <div>© 2026 Akili. Built by Victor Ndunda & contributors.</div>
