...
8. Prioritize by business impact: revenue > risk > efficiency > curiosity.`;
  ...
  try {
    ...
    return {
      ...
      methodology: sections['Methodology'] ?? sections['methodology'] ?? 'Multi-stage AI analysis pipeline across 7 stages.',
...
function fallbackNarrative(req: NarrativeRequest): NarrativeResponse {
  ...
  return {
    ...
    methodology: 'The Busara pipeline employs a 7-stage analysis pipeline with parallelism within each stage.',
